// This sketch has been adapted from a example in the library here:
// https://github.com/prenticedavid/MCUFRIEND_kbv

// The main change is a new tab that contains the screenshot server functions
// that pass a screenshot to the Processing client running on a PC. It is
// only necessary to call screenServer() at relevant points in the code.
// The screen pixel width and height will be passed to the client, thus screen
// orientation and size changes are catered for automatically.

// The client sketch runs under "Processing" on a PC, which is an rduino like IDE
// written by Arduino team members Ben Fry ad Csey Reas, a copy can be downloaded
// here: https://processing.org/

// Captured images are stored in the Processing sketch folder, use the Processing
// IDE (not Arduino IDE) "Sketch" menu option "Show Sketch Folder" or press Ctrl+K

// The sketch has been tested with ILI9481 480 x 320 and ILI9341 320 x 240
// shields plugged into an Arduino Due. The Native serial port has been used
// to transfer screenshots faster, though this could be changed for a Mega etc.
